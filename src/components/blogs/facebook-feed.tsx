...
export default function FacebookFeed() {
  ...
  if (iframeFailed) {
    return (
      <div className="w-full max-w-[500px] mx-auto border border-red-100 rounded-2xl p-8 bg-red-50/50 text-center shadow-sm backdrop-blur-sm">
  ...
  return (
    <div className="w-full max-w-[500px] mx-auto bg-white rounded-2xl border border-primary/10 shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col">
      ...
      <div className="relative w-full aspect-[5/6] sm:h-[600px] flex items-center justify-center bg-muted/20">
        <iframe
